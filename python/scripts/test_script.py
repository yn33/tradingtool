    ...
    for interval in intervals:
        ...
        if PREV_TESTPATH == testsPath:
            ...
            if interval == PREV_INTERVAL:
                ...
                PREV_RES = PREV_RES - RESISTANCE_SCALE + 0.5
        
        elif PREV_TESTPATH != "0":
            print("Wrong path for tests file.")
            exit()
                                    ...
                                    while VOLUME_SCALE_OFFSET <= 2.0:
                                        ...
                                        while SUPPORT_SCALE_OFFSET <= 2.0:
                                            ...
                                            while RESISTANCE_SCALE_OFFSET <= 2.0:
                                                ...
                                                result = runScan(asset, pattern, barsArray, reverseArray, SARArray, trendsArray, asset.constants, dataLen)
                                                resultString = "{} {} {} {} {} {} {} {} {} {} {} {} ".format(
                                                interval,
                                                ...
                                                if printCount == 1000:
                                                    print(resultString)
                                                    printCount = 0
                                                testf.write(resultString + '\n')
                                                prevf.seek(0)
                                                prevf.write(testsPath + " " + resultString)
                                                counter += 1
