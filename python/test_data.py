...
for arg in sys.argv[1:]:
    ...
    for line in f:
        ...
        supp = float(array[9])
        res = float(array[10])
        value = float(array[11])

        IDString = "{} {} {} {} {} {} {} {} {} {} {}"\
        .format(interval, volume, change, score, amount, chunk, pivot, cscale, vscale, supp, res)
...
for x in range(10):
    ...
    n = amounts[key]
    value = bestValues[x]
    resString = "{}. In: {}, Vo: {}, Ch: {}, Sc: {}, Am: {}, Chu: {}, Pi: {}, Cs: {}, Vs: {}, Su: {}, Res: {}, Avg: {}, N: {}"\
    .format(x + 1, interval, volume, change, score, amount, chunk, pivot, cscale, vscale, supp, res, value, n)
    print(resString)
    if x == 0:
        ...
        f = open(paths.PARABOLIC_CONSTANTS_PATH, "w")
